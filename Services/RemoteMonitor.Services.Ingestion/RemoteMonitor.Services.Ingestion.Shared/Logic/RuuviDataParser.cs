...
{
    public class RuuviDataParser
    {
        private ILogger _logger;

        public RuuviDataParser(ILogger logger) 
        {
            _logger = logger;
        }        
        ...
        public void CutTagToLists(string data)
        {
            ...
            if (vers == "05")
            {
                ...
                addTx(data);
                addMovecount(data.Substring(44, 2));
        ...
        private void addTemp(string data)
        {
            if (vers == "05")
            {
                ...
                //_logger.LogInformation($"Ruuvi Data Parser: {data} - {t}");
